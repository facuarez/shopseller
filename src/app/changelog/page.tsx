    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-text-secondary max-w-2xl mb-4">
          Cronología de cambios reales en políticas, comisiones, features y expansiones de TTS en Europa.
          Documentado manualmente porque TikTok no tiene un changelog público para sellers.
        </p>
