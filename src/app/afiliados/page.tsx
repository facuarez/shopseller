...
const TOOLS = [
  ...
  },
  {
    ...
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF5A1F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87" /><path d="M16 3.13a4 4 0 010 7.75" /></svg>,
    title: "Analizador de órdenes",
    description: "Subí tu CSV de TTS y obtené rankings de afiliados, videos y productos. 100% en tu navegador.",
    status: "disponible",
  },
];
