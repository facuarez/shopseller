  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-text-secondary mb-8">
        Seguimiento de ventas generadas por creadores afiliados. Métricas por creador, producto y período.
      </p>

      <div className="border-2 border-dashed border-border rounded-lg p-12 text-center">
        <p className="text-xl font-medium text-text mb-2">Próximamente</p>
        <p className="text-sm text-text-secondary max-w-md mx-auto">
          Esta herramienta está en desarrollo. Permitirá trackear las ventas que generan tus creadores
